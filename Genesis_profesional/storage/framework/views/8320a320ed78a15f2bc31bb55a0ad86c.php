...
<head>
    ...
    <style>
        ...
        body, html {
            ...
            background: linear-gradient(rgba(0, 11, 88, 0.65), rgba(0, 11, 88, 0.65)), url('<?php echo e(asset('images/Fondo_login.png')); ?>') no-repeat center center fixed;
...
<body>
    ...
    <div id="app" class="w-100 d-flex justify-content-center px-3">
        ...
        <div class="auth-card" v-if="vistaActual === 'login'">
            ...
            <!-- Logo UGB -->
            <img src="<?php echo e(asset('images/logo_ugb.png')); ?>" alt="Logo UGB" class="mb-3 mx-auto" style="height: 72px; object-fit: contain; display: block;">
...
</html><?php /**PATH C:\Users\josec\OneDrive\Escritorio\Aplicacion_web\Genesis_profesional\resources\views/login.blade.php ENDPATH**/ ?>