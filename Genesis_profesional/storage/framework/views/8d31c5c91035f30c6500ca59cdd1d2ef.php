    ...
    <div id="app">
        ...
        <header class="navbar-ugb">
            <a href="#" @click.prevent="cambiarTab('inicio')" class="navbar-brand-ugb">
                <img src="<?php echo e(asset('images/LOGO_WEB_INF.png')); ?>" alt="Logo UGB" style="height: 80px; object-fit: contain; filter: brightness(0) invert(1);">
            </a>
            ...
            <transition name="fade" mode="out-in">
                ...
                <div v-if="activeTab === 'inicio'" key="inicio">
                    <div class="hero-row">
                        ...
                        <div class="hero-image-block">
                            <img src="<?php echo e(asset('images/Web_info_imagen_1.png')); ?>" alt="Mentoría tecnológica" class="hero-img">
                        </div>
                    </div>
                    <div class="hero-row reverse-mobile">
                        <div class="hero-image-block">
                            <img src="<?php echo e(asset('images/web_info_imagen_2.png')); ?>" alt="Equipo de desarrollo" class="hero-img">
                        </div>
                        <div class="hero-text-block">
                            <h2 class="hero-title">
                ...
                <div v-else-if="activeTab === 'empresas'" key="empresas">
                    ...
                    <div class="asymmetric-block">
                        ...
                        <div class="block-img-container">
                            <img src="<?php echo e(asset('images/empresas_socias_imagen_1.png')); ?>" alt="Alianza estratégica" class="block-img">
                        </div>
                    </div>
                    <!-- Fila 2 -->
                    <div class="asymmetric-block" style="flex-direction: row-reverse;">
                        ...
                        <div class="block-img-container">
                            <img src="<?php echo e(asset('images/empresas_socias_imagen_2.png')); ?>" alt="Espacio de trabajo" class="block-img">
                        </div>
                    </div>
                </div>
                ...
                <div v-else-if="activeTab === 'areas'" key="areas">
                    <div class="hero-row mb-5">
                        ...
                        <div class="hero-image-block">
                            <img src="<?php echo e(asset('images/areas_imagen_1.png')); ?>" alt="Ingenieros trabajando" class="hero-img">
                        </div>
                    </div>
                ...
                <div v-else-if="activeTab === 'requisitos'" key="requisitos">
                    ...
                    <div class="asymmetric-block">
                        <div class="block-img-container">
                            <img src="<?php echo e(asset('images/requisitos_imagen_1.png')); ?>" alt="Estudiante en laptop" class="block-img">
                        </div>
                        <div class="block-text">
                    ...
                    <div class="asymmetric-block" style="flex-direction: row-reverse;">
                        <div class="block-img-container">
                            <img src="<?php echo e(asset('images/requisitos_imagen_2.png')); ?>" alt="Reunión de asesoría" class="block-img">
                        </div>
                        <div class="block-text">
                            <ul class="requisito-list">
                                <li>
                ...
                <div v-else-if="activeTab === 'alcance'" key="alcance">
                    <div class="hero-row mb-5">
                        ...
                        <div class="hero-image-block">
                            <img src="<?php echo e(asset('images/alcances_imagen_1.png')); ?>" alt="Reunión académica" class="hero-img">
                        </div>
                    </div>
            ...
            <div class="footer-inner" style="max-width: 1300px; margin: 0 auto;">
                <div class="row footer-grid align-items-center">
                    ...
                    <div class="col-md-5 mb-4 mb-md-0 d-flex align-items-center justify-content-center justify-content-md-start">
                        <img src="<?php echo e(asset('images/LOGO_WEB_INF.png')); ?>" alt="Logo UGB" style="width: 397.08px; height: 204.951px; transform: rotate(0.921deg); aspect-ratio: 31/16; object-fit: contain; filter: brightness(0) invert(1);">
                    </div>
...
</html><?php /**PATH C:\Users\josec\OneDrive\Escritorio\Aplicacion_web\Genesis_profesional\resources\views/welcome.blade.php ENDPATH**/ ?>